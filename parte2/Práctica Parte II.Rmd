...
# Seleccionamos las componentes principales que expliquen al menos el 90% de la varianza
cumsum <- cumsum(pr.out$sdev^2)
cumsum <- cumsum / sum(pr.out$sdev^2)
ncomp <- which(cumsum > .8)[1]
ncomp
