...
En esta sección analizaremos las variables del dataset y las agruparemos por temáticas. Se describirá el significado de cada grupo de características identificado. Toda la información acerca de las variables se ha extraído del documento `'ReadMe.txt` del repositorio CICFlowMeter. Dicho documento se encuentra disponible en [CICFlowMeter/ReadMe.txt] (https://github.com/ahlashkari/CICFlowMeter/blob/master/ReadMe.txt).
...
Se puede ver en la imagen del biplot que tenemos demasiados predictores y demasiados valores; no se puede sacar nada en claro. Además, como PC1 y PC2 explican solo el 35.65% de la varianza, el biplot tampoco sería representativo.
