...
De esta forma ya tenemos cinco pliegues preparados para realizar validación cruzada.
...
Una vez hemos realizado la validación cruzada, vamos a representar los resultados y seleccionar los hiperparámetros que han obtenido el mejor F1-Score.
```{r resultados VD}
...
Definimos los valores de nodos, dropout y épocas que vamos a probar.
...
# Creamos una matriz con todas las combinaciones posibles de los valores de nodos, dropout y épocas
