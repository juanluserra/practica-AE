...
- Las variables no están ni normalizadas ni estandarizadas. No es necesario normalizarlas en este caso.
- Pueden haber variables en escala logarítmica porque dependan de otras de forma exponencial o de potencias, de forma que pasen a tener expresiones lineales respecto a estas. También puede ser que tengan valores de órdenes de magnitud muy diferentes, haciendo que sean más fáciles de tratar en escala logarítmica.
...
patients <- nrow(datos.svi0)

# Hacemos el porcentaje
porcentaje <- nrow(datos.svi0.gleason7) / patients * 100
porcentaje
```
