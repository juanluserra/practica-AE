...
$$
Podemos ver como a partir de la relación entre los logaritmos se ha obtenido una relacón de potencias.
...
probabilidad del 7% de falso positivo en SVI = 0 y 16.6% en SVI = 1.
...
# Hacemos una regesión de componentes principales (PCR) con el conjunto de entrenamiento
